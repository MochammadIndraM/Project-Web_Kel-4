...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['tanggal']) && $_POST['tanggal'] != ""  && isset($_POST['id_print']) && $_POST['id_print'] != "" && isset($_POST['berapa_kali_print']) && $_POST['berapa_kali_print'] != "" && isset($_POST['jumlah_kertas']) && $_POST['jumlah_kertas'] != "" && isset($_POST['total_harga']) && $_POST['total_harga'] != ""  && isset($_POST['status']) && $_POST['status'] != "" && isset($_POST['id_user']) && $_POST['id_user'] != "" && isset($_POST['bukti_pembayaran']) && $_POST['bukti_pembayaran'] != "" ) {
        ...
        if($count == 0){
            ...
            $insert = "INSERT INTO transaksi(id_transaksi,tanggal,id_print,berapa_kali_print,jumlah_kertas,total_harga,status) VALUES ('".$id_transaksi."','".$tanggal."','".$id_print."','".$berapa_kali_print."','".$jumlah_kertas."','".$total_harga."','".$status."')";
